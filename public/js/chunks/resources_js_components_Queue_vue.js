...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.$socket.on('loadtimestamp', function (time) {
      _this.percentage = time / _this.duration * 100;
    });
    this.$socket.on('taketotaldur', function (time) {
      _this.duration = time;
    });
  },
  data: function data() {
  ...
  methods: {
    mGetList: function mGetList() {
      ...
      axios.get("api/play").then(function (res) {
        if (res.data.length != 0) {
          ...
          _this2.listhead = Object.keys(res.data[0]);
        } else {
          _this2.list = [];
        }
      })["finally"](function () {
        setTimeout(function () {
          _this2.islistloaded = true;
        }, 2000);
      });
    },
    mGetQueue: function mGetQueue(val) {
      var _this3 = this;
      if (!val) this.isqueueloaded = false;
      axios.get("api/play?mode=q").then(function (res) {
        if (res.data.length != 0) {
          _this3.queue = res.data;
          _this3.queuehead = Object.keys(res.data[0]);
          _this3.current = _this3.queue[0].Title;
        } else {
          _this3.queue = [];
        }
      })["finally"](function () {
        setTimeout(function () {
          _this3.isqueueloaded = true;
        }, 1000);
      });
    },
    // NOTE mPagination 
    mPagination: function mPagination(todo) {
      if (todo == 'next') {
        this.page++;
      } else if (todo == 'prev') {
        this.page--;
    ...
    mToQueue: function mToQueue(data) {
      ...
      axios.post("api/play", data)["finally"](function () {
        _this4.$socket.emit('reload_data', 'put');
      });
    },
    //NOTE mUpload
    ...
    mClear: function mClear() {
      ...
      axios["delete"]("api/play/clear")["finally"](function () {
        _this6.$socket.emit('reload_data', 'clear');
      });
    },
    mToCancel: function mToCancel(data) {
      var _this7 = this;
      axios["delete"]("api/play/cancel?no=".concat(data.Prio))["finally"](function () {
        _this7.$socket.emit('reload_data', 'cancel');
      });
    },
    mNext: function mNext() {
      var _this8 = this;
      axios["delete"]("api/play/del")["finally"](function () {
        //update queue
        _this8.$socket.emit('reload_data', 'next');
        //new set of video
      });
    },
    ...
    mVidDuration: function mVidDuration() {
      this.$socket.emit('setdur', this.percentage);
    },
    mFullscreen: function mFullscreen() {
      this.$socket.emit('reqfullscreen');
    },
    mReload: function mReload() {
      this.$socket.emit('reqreload');
    },
    mGetRandomNumber: function mGetRandomNumber() {
      var res = [];
      for (var x = 0; x < this.randomset; x++) {
        var num = Math.floor(Math.random() * (this.list.length - 0)) + 0;
    ...
    mChangePrio: function mChangePrio(val) {
      var _this9 = this;
      if (val.oldIndex != val.newIndex) {
        axios.patch("api/play/changeprio?old=".concat(val.oldIndex + 1, "&new=").concat(val.newIndex + 1))["finally"](function () {
          _this9.$socket.emit('reload_data', 'changeprio');
        });
      }
    }
  },
  computed: {
    ...
    cFilter: function cFilter() {
      ...
      var result = '';
      if (this.search) {
        result = this.list.filter(function (rec) {
          return rec.Title.toUpperCase().includes(_this10.search.toUpperCase());
        });
    ...
    cResizeDialog: function cResizeDialog() {
      return this.$vuetify.breakpoint.xl ? '15%' : this.$vuetify.breakpoint.lg ? '20%' : this.$vuetify.breakpoint.md ? '28%' : this.$vuetify.breakpoint.sm ? '45%' : '100%';
    }
  },
  watch: {
    // NOTE pagectrl 
    page: function page(val) {
      if (val > this.pages) this.page = this.pages;
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css&":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Queue_vue_vue_type_style_index_0_id_6aa8a136_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Queue_vue_vue_type_style_index_0_id_6aa8a136_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _Queue_vue_vue_type_style_index_0_id_6aa8a136_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css& */ "./resources/js/components/Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css&");
...
/***/ "./resources/js/components/Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css&":
/*!****************************************************************************************************!*\
  !*** ./resources/js/components/Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css& ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Queue_vue_vue_type_style_index_0_id_6aa8a136_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Queue.vue?vue&type=style&index=0&id=6aa8a136&scoped=true&lang=css&");
  ...
  return _c(
    ...
    [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        {
                          staticClass: "pt-1",
                          staticStyle: { "border-radius": "10px 0 0 10px" },
                          attrs: { color: "#D3D3D3", "x-small": "" },
                        },
                        [
                          _c("v-text-field", {
                      ...
                      _c(
                        "v-btn",
                        {
                          ...
                          attrs: {
                            disabled: _vm.randomset < 1,
                            dark: _vm.randomset < 1,
                            "x-small": "",
                          },
                          on: { click: _vm.mGetRandomNumber },
                        },
                        [
                          _c("v-icon", [
                            _vm._v(
                    ...
                    [
                      ...
                      _c(
                        "v-simple-table",
                        {
                          ...
                          attrs: {
                            "fixed-header": "",
                            height: _vm.$vuetify.breakpoint.height * 0.57,
                          },
                        },
                        [
                          !_vm.islistloaded
                            ...
                            : _vm.cFilter.length == 0
                            ? _c("div", [
                                _c("h1", { staticClass: "promptempty" }, [
                      ...
                      _c(
                        "div",
                        { staticClass: "mt-1 d-flex justify-center" },
                        [
                          _c(
                            "v-btn",
                            {
                          ...
                          _c(
                            "v-btn",
                            {
                              staticClass: "pt-1",
                              attrs: {
                                color: _vm.isPageSel ? "#D3D3D3" : "white",
                                "x-small": "",
                              },
                              on: {
                                click: function ($event) {
                          ...
                          _c(
                            "v-btn",
                            {
                              ...
                              attrs: {
                                ...
                                dark: _vm.page == _vm.pages,
                              },
                              on: {
                                click: function ($event) {
                                  return _vm.mPagination("next")
                                },
                              },
                            },
                            [
                    ...
                    [
                      ...
                      _c(
                        "v-simple-table",
                        {
                          ...
                          attrs: {
                            "fixed-header": "",
                            height: _vm.$vuetify.breakpoint.height * 0.65,
                          },
                        },
                        [
                          !_vm.isqueueloaded
      ...
      _c(
        "v-dialog",
        {
          attrs: { "max-width": _vm.cResizeDialog },
          model: {
            value: _vm.openctrl,
            callback: function ($$v) {
              _vm.openctrl = $$v
        ...
        [
          _c(
            "v-card",
            { staticClass: "text-center", attrs: { color: "black" } },
            [
              _c(
                "v-card-title",
                [
                ...
                [
                  ...
                  _c(
                    "v-btn",
                    {
                      staticClass: "ml-1",
                      attrs: {
                        disabled: _vm.queue.length <= 1,
                        dark: _vm.queue.length <= 1,
                      },
                      on: { click: _vm.mNext },
                    },
                    [
      ...
      _c(
        "v-dialog",
        {
          attrs: { persistent: "", "max-width": _vm.cResizeDialog },
          model: {
            value: _vm.toupload,
            callback: function ($$v) {
              _vm.toupload = $$v
